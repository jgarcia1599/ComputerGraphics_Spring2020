...
function objInit(Obj){
	...
	if(Obj.normals == undefined)   computeNormals();
	if(Obj.triangles == undefined) createTriangles();
	if(Obj.edges == undefined)     createEdges();      // for displaying wireframe 
	
	var Attributes = ["vPosition", "vNormal"];
	var Uniforms   = ["M", "N", "Ka", "Kd", "Ks", "shininess", "drawWireframe"];
